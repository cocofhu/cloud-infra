  ...
  ctx.inject(['systemPrompt'], (c) => {
    ...
    prompt.section({
      ...
      text: () => {
        ...
        return [
          `Cloud domains / DNS / 解析 / DNSPod / 证书 / SSL / 我的证书 / 注册 / 可注册 / 我的域名 / CDB / 云数据库 / MySQL / 云服务器 / 轻量 / CVM / 实例: call ONLY cloud_infra_query. Never web_search.`,
          ...
          'After the table appears, one or two short sentences. Click 证书 ID for full detail. CDB list uses 登录 and 管理. Do not print secrets, PEM, or full record dumps.',
        ].join(' ')
      },
    })
  })
